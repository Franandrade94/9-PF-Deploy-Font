...
class Bizcocho extends Component {
    ...
    render(){
        ...
        const products2 = products?.filter(product => product?.TypeId == 2 && product?.deleted == false);
        ...
        return(
            <div className="BizcochoCard-Container">
                <div>
                    <div className="BizcochoCard-Home">
...
export default connect(mapStateToProps, mapDispatchToProps)(Bizcocho);